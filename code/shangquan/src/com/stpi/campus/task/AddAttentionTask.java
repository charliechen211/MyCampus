 ...
 */
public class AddAttentionTask extends AsyncTask<String, Void, String> {
    ...
    public AddAttentionTask(Context theActivity, ProgressBar theProgressBar, UtilTaskCallBack theCallBack) {
    ...
    protected String doInBackground(String... args) {
        String url = activity.getString(R.string.add_friend_head);
    ...
    protected void onPostExecute(final String retCode) {
        ...
        if (retCode.equals("error"))
            ...
            UserInfo.friendList.add(friendId);
