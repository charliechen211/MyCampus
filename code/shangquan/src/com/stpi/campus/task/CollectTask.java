...
public class CollectTask extends AsyncTask<String, Void, String> {
    ...
    public CollectTask(Context theActivity, ProgressBar theProgressBar) {
    ...
    protected String doInBackground(String... args) {
        String url = activity.getString(R.string.add_collect_head);
        ...
        if (res.getState().equals("success"))
            return "success";
        else if (res.getState().equals("exist"))
            return "exist";
        else
            return "error";
    ...
    protected void onPostExecute(final String retCode) {
        ...
        if (retCode.equals("exist"))
            Toast.makeText(activity, "已收藏过", Toast.LENGTH_SHORT).show();
