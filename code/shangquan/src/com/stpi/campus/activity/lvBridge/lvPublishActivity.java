 ...
 */
public class lvPublishActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lv_publish);
    ...
    private void showCameraOptionDialog() {
        ...
        if(cameraDialog == null)
            cameraDialog = new AlertDialog.Builder(lvPublishActivity.this)
...
//        this.startActivity(intent);
    ...
    private void attemptSubmit() {
        ...
        int circleId = UserInfo.circleId;
        ...
        publishTask.execute(userId, String.valueOf(circleId), title, description, "2", contact);
    ...
    public class PublishTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            String url = lvPublishActivity.this.getString(R.string.add_shlv_info_head);
        ...
        protected void onPostExecute(final String retCode) {
            ...
            if (retCode.equals("error"))
                Toast.makeText(lvPublishActivity.this, "发布失败", Toast.LENGTH_SHORT).show();
            else {
                Toast.makeText(lvPublishActivity.this, "发布成功", Toast.LENGTH_SHORT).show();
                lvPublishActivity.this.finish();
            }
        }
