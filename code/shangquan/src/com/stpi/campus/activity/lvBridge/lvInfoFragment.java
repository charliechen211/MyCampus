 ...
 */
public class lvInfoFragment extends RefreshableFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lv_list, container, false);
    ...
    private void initEvents() {
        ...
        adapter = new SimpleAdapter(lvInfoFragment.this.getActivity(), datas, R.layout.sh_info_item,
                new String[]{"picture", "title", "createTime", "replyNum", "description"},
                new int[]{R.id.picture, R.id.title, R.id.createTime, R.id.replyNum,
                        R.id.description});
        ...
        infoList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(lvInfoFragment.this.getActivity(), lvCommentActivity.class);
            ...
            public void onScrollStateChanged(AbsListView absListView, int scrollState) {
                if (lastItem == data.size() && scrollState == SCROLL_STATE_IDLE) {
                    if (have_more) {
                        ...
                        Toast.makeText(lvInfoFragment.this.getActivity(), "已到末尾", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void setActionBarMenu() {
        getActivity().getActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable
                .actionbar_color_lbridge));
        menu.clear();
        menu.add(0, R.integer.add_lv_item, 0, "发帖").setIcon(R.drawable.actionbar_add_icon).setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    }
    ...
    private void showAddInfoDialog() {
        Intent intent = new Intent(lvInfoFragment.this.getActivity(), lvPublishActivity.class);
        startActivity(intent);
    }
    ...
    class LoadInfoTask extends
        ...
        protected List<Map<String, Object>> doInBackground(String... args) {
            String url = lvInfoFragment.this
                    .getString(R.string.shlv_info_head);
