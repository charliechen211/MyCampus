 ...
 */
public class shCommentActivity extends Activity {
...
//                break;
    ...
    private void collect() {
        ...
        collectTask.execute(UserInfo.userId, "4", p_shId);
...
//        loginConfirm();
//
//        Intent intent = new Intent(shCommentActivity.this, CommentActivity.class);
...
//    }
    ...
    private void attemptAddComment() {
        ...
        if (p_shId.equals(""))
            return;
        commentTask.execute(UserInfo.userId, p_shId, comment, "1");
        progressBar.setVisibility(View.VISIBLE);
    ...
    private void loginConfirm() {
        if (UserInfo.userId.equals("0")) {
            Toast.makeText(shCommentActivity.this, "请先登录", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(shCommentActivity.this, LoginActivity.class);
            startActivity(intent);
        }
    }
    ...
    class LoadCommentTask extends
        ...
        protected List<Map<String, Object>> doInBackground(String... args) {
            ...
            String url = shCommentActivity.this.getString(R.string.fetch_comment_head);
        ...
        protected void onPostExecute(List<Map<String, Object>> data) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(shCommentActivity.this, data, R.layout.shcomment_list_item,
    ...
    public class CommentTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            String url = shCommentActivity.this.getString(R.string.add_comment_head);
            List<NameValuePair> params = new ArrayList<NameValuePair>();
        ...
        protected void onPostExecute(final String retCode) {
            ...
            if (retCode.equals("error"))
                Toast.makeText(shCommentActivity.this, "评论失败", Toast.LENGTH_SHORT).show();
            else {
                Toast.makeText(shCommentActivity.this, "评论成功", Toast.LENGTH_SHORT).show();
                new LoadCommentTask().execute();
            }
        }
